...
class Database_Connector:
    ...
    def get_table_data(self, connection=None, table_name: str = None, limit: int = 1000):
    ...
    def get_table_data_selected(self, connection=None, table_name: str = None, selected_columns: list = None, limit: int = 1000):
        if connection is None:
            connection = self.connection
    ...
    def get_filtered_data(self, connection=None, table_name: str = None, filter_conditions: dict = None, selected_columns: list = None, limit: int = 1000):
        if connection is None:
            connection = self.connection
        if table_name is None:
            raise ValueError("table_name must be provided")
